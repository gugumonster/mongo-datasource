...
//import com.gigaspaces.data.issue.Issue;
//import com.gigaspaces.data.issue.Priority;
//import com.gigaspaces.data.issue.User;
//
///**
// * A representation of a JIRA Issue (as POJO)
// */
//@SpaceClass
//public class MongoIssuePojo
//implements Issue
//{
...
//	{
//		if ( !(obj instanceof CassandraIssuePojo) )
//			return false;
//
//		CassandraIssuePojo otherIssue = (CassandraIssuePojo)obj;
//
//		//verify key
...
//	{
//		try{
//			CassandraIssuePojo deep = (CassandraIssuePojo)clone();
