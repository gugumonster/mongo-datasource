...
public class DifferentTypesQueryMongoTest extends AbstractMongoTest {
	...
	public void test() {
		...
		testDataIterator(new SpaceDocument(TEST_CF).setProperty(LONG_COL,
				LONG_COL_VAL));
		testDataIterator(new SpaceDocument(TEST_CF).setProperty(STRING_COL,
				STRING_COL_VAL));
		...
		testDataIterator(new SpaceDocument(TEST_CF).setProperty(DYNAMIC_COL_7,
				DYNAMIC_COL_7_VAL));
		testDataIterator(new SpaceDocument(TEST_CF).setProperty(DYNAMIC_COL_8,
				DYNAMIC_COL_8_VAL));

		testDataIterator(new SpaceDocument(TEST_CF).setProperty(LONG_COL,
				LONG_COL_VAL).setProperty(STRING_COL, STRING_COL_VAL));

		testDataIterator(new SpaceDocument(TEST_CF).setProperty(LONG_COL,
				LONG_COL_VAL).setProperty(DYNAMIC_COL_1, DYNAMIC_COL_1_VAL));
	...
	private void testDataIterator(SpaceDocument spaceDocument) {
		...
		DataSourceQuery dataSourceQuery = new MockDataSourceQuery(
				createMockSpaceTypeDescriptor(), spaceDocument,
				Integer.MAX_VALUE);
