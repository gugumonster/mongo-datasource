 ...
 * 
 * Indexed by: key, created, updated, reporter, priority MetaDataEntry,
...
public interface Issue extends Comparable<Issue>, Cloneable {
	...
	/**
	 * @return votes string representation - used for regular expressions and
	 *         alike
	 */
	 ...
	 * 
	 * @param p
	 *            priority to assign for this issue.
	 */
	public void setPriority(Priority p);

	/**
	 * votes for this issue - increases priority every 5 votes unless current
	 * priority is higher than voted priority. 'updated' time is modified to
	 * now.
	 * 
	 * Priority.TRIVIAL 0-5 votes Priority.MINOR 5-10 votes Priority.MEDIUM
	 * 10-15 votes Priority.MAJOR 15-20 votes Priority.CRITICAL 20-25 votes
	 * Priority.BLOCKER 25+ votes
	 * 
	...
	/**
	 * Shallow clones this Issue. Same as calling {@link Object#clone()}
	 * encapsulating the throws and return value.
	 * 
